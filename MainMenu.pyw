...
ASSETS_DIR = os.path.join(BASE_DIR, "assets", "Menu")  # Directory for assets like images

# Function to start the game
def start_game():
    """Start the game."""
    # Check if all selections (mode, style, language) are made
...
def get_player_names(mode):
    ...
    def submit_names():
        # Get entered names and ensure they are not empty
    ...
    name_window = tk.Toplevel(main_menu_root)  # Create a new top-level window
    ...
    # Define window dimensions and position it at the center of the screen
    window_width = 400
    window_height = 300
